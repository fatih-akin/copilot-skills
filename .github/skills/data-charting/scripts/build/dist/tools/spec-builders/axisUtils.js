 ...
 */
export const xAxisConfig = (rows, fieldName, fieldType = "string", extraProps = {}) => {
    const isNominal = fieldType === "string" || fieldType === "boolean";
 ...
 */
export const yAxisConfig = (rows, fieldName, fieldType = "string", extraProps = {}) => {
    const isNominal = fieldType === "string" || fieldType === "boolean";
    const uniqueCount = isNominal ? new Set(rows.map((r) => r[fieldName])).size : 0;
