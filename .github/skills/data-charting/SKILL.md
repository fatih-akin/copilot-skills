...
Just use the `.github/skills/data-charting/` folder as-is.
...
- Root `scripts/*.mjs`: runnable helper scripts that import from `.github/skills/data-charting/scripts/build/dist/`
