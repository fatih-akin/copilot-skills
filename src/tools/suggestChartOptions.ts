import type { DataRow, InferredSchema, SchemaField, SupportedChartType } from "../types.js";
...
const pushDirectOptions = (schema: InferredSchema, options: ChartOption[]): void => {
...
export const suggestChartOptions = ({ rows, schema, intent, rowLimit }: SuggestChartOptionsInput): SuggestedChartOptionsResult => {
  if (rows.length === 0) {
