import type { DataRow, FieldType, InferredSchema } from "../types.js";
...
const detectFieldType = (values: Array<string | number | boolean | null>): FieldType => {
...
export const inferSchema = (rows: DataRow[]): InferredSchema => {
  if (rows.length === 0) {
